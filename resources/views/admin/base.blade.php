<?php
  if(Session::has('role') and Session::get('role') != 'admin'){
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('admin/inputakun')}}"><i class="fa fa-circle-o"></i> Masukan Akun</a></li>
            <li><a href="{{url('admin/ubahakun')}}"><i class="fa fa-circle-o"></i> Ubah Akun</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Hepus Akun</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>KELOLA KELAS</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{url('admin/inputkelas')}}"><i class="fa fa-circle-o"></i> Masukan Kelas</a></li>
            <li><a href="{{url('admin/ubahkelas')}}"><i class="fa fa-circle-o"></i> Ubah Kelas</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Hepus Kelas</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-edit"></i> <span>KELOLA PRODI</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{url('admin/inputprodi')}}"><i class="fa fa-circle-o"></i> Masukan Prodi</a></li>
            <li><a href="{{url('admin/ubahprodi')}}"><i class="fa fa-circle-o"></i> Ubah Prodi</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Hepus Prodi</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-building"></i> <span>KELOLA GEDUNG</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{url('admin/inputgedung')}}"><i class="fa fa-circle-o"></i> Masukan Gedung</a></li>
            <li><a href="{{url('admin/ubahgedung')}}"><i class="fa fa-circle-o"></i> Ubah Gedung</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Hepus Gedung</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-building"></i> <span>KELOLA RUANGAN</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{url('admin/inputruangan')}}"><i class="fa fa-circle-o"></i> Masukan Ruangan</a></li>
            <li><a href="{{url('admin/ubahruangan')}}"><i class="fa fa-circle-o"></i> Ubah Ruangan</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Hepus Ruangan</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-building"></i> <span>KELOLA MATAKULIAH</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{url('admin/inputmatakuliah')}}"><i class="fa fa-circle-o"></i> Masukan Matakuliah</a></li>
            <li><a href="{{url('admin/ubahmatakuliah')}}"><i class="fa fa-circle-o"></i> Ubah Matakuliah</a></li>
            <li><a href=""><i class="fa fa-circle-o"></i> Hepus Gedung</a></li>
          </ul>
        </li>
    </section>
