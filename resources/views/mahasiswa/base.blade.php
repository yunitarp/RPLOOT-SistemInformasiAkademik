<?php
  if(Session::has('role') and Session::get('role') != 'mahasiswa'){
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-files-o"></i> <span>NILAI</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{url('mahasiswa/lihatnilai')}}"><i class="fa fa-circle-o"></i>Lihat Nilai</a></li>
            <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i>Lihat Nilai Semester</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/forms/general.html"><i class="fa fa-circle-o"></i>Status Pembayaran</a></li>
            <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i>Tagihan Pembayaran</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('mahasiswa/lihatpresensi')}}"><i class="fa fa-circle-o"></i>Lihat Presensi</a></li>
            <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i>Cetak Presensi</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-th"></i> <span>REGISTERASI</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a ><i class="fa fa-circle-o"></i>Registerasi Matakuliah</a></li>
            <li><a href="{{url('mahasiswa/jadwal')}}"><i class="fa fa-circle-o"></i>Jadwal Mahasiswa</a></li>
            <li><a href="pages/forms/advanced.html"><i class="fa fa-circle-o"></i>Jadwal Ujian Mahasiswa</a></li>
          </ul>
        </li>
    </section>
    <!-- /.sidebar -->
