<?php
  if(Session::has('role') and Session::get('role') != 'dosen'){
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('dosen/nilai/inputnilai')}}"><i class="fa fa-circle-o"></i>Masukkan Nilai</a></li>
          </ul>
        </li>
        <li>
          ...
          <ul class="treeview-menu">
            <li><a href="{{url('dosen/presensi/inputpresensi')}}"><i class="fa fa-circle-o"></i>Masukkan Presensi</a></li>
            <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i>Ubah Presensi</a></li>
            <li><a href="pages/layout/boxed.html"><i class="fa fa-circle-o"></i>Cetak Presensi</a></li>
          </ul>
        </li>
        <li>
          <a href="pages/widgets.html">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/layout/top-nav.html"><i class="fa fa-circle-o"></i>ACC Registrasi Matakuliah</a></li>
            <li><a href="{{url('dosen')}}/registerasi/jadwaldosen"><i class="fa fa-circle-o"></i>Jadwal Mengajar</a></li>
          </ul>
        </li>
    </section>
    <!-- /.sidebar -->
